/*
 * @Descripttion: 资金往来结算票据
 * @version: 
 * @Author: lugfa
 * @Date: 2023-05-29 09:38:38
 * @LastEditors: lugfa
 * @LastEditTime: 2023-08-01 16:01:20
 * @FilePath: /yondif-a-ar-fe/yondif/src/views/ArAebf/Detail/compoents/ArAebfInvoice/compoents/CapTransSettleBill/index.jsx
 */
...
class CapTransSettleBill extends Component {
  constructor(props) {
    super(props)
    this.state = {
      arr: Array.from((new Array(6)).keys()),
      detailTableHead: [
        { name: '收款项目', width: 250, key: 'name' },
        { name: '单价', width: 150, key: 'standard' },
        { name: '数量', width: 150, key: 'num', inputType: '03' },
  ...
  render () {
    ...
    return (<div className='cap-trans-settle-bill' >
      <div className="bg">
          ...
          <div className="invoice-content">
            <div className="invoice-content-middle">
              ...
              <div className="bottom-table">
                ...
                <div className="bottom-item">
                  <label className="label-money">备注</label>
...
export default CapTransSettleBill;
